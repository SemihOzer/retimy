...
public class UpdateUserRequest {
    ...
    public UpdateUserRequest(String id, String first_name, String last_name, String userName, String email, String password, Date birth_date, Timestamp timestamp, List<Post> posts, List<Post> liked_posts, List<Comment> comments, List<User> followers, List<User> followings, List<User> known_users) {
        this.id = id;
